...
public class PostRepository {
    ...
    public void listenToNewPost(final Runnable runOnNewPost, String lastPostId) {
        FirebasePostManager.getInstance().listenToNewPost(new FirebasePostManager.NewPostListener() {
            @Override
